...
export const expectedMonthly: MortgageSummary = {
    ...
    firstTerm: { numPayments: 60, paidInterest: 0, paidPrincipal: 0, paidInTotal: 35075.40 },
...
export const expectedWeekly: MortgageSummary = {
    ...
    firstTerm: { numPayments: 260, paidInterest: 0, paidPrincipal: 0, paidInTotal: 35047.23 },
...
export const expectedBiWeekly: MortgageSummary = {
    ...
    firstTerm: { numPayments: 130, paidInterest: 0, paidPrincipal: 0, paidInTotal: 35055.68 },
...
export const expected200kPrincipalAmortization10yrs: MortgageSummary = {
    payment: 2121.3103,
    frequencyLabel: 'Monthly (12x per year)',
    firstTerm: { numPayments: 60, paidInterest: 0, paidPrincipal: 0, paidInTotal: 127278.6182 },
...
export const expected3yrsTerm: MortgageSummary = {
    payment: 423.8543,
    frequencyLabel: 'Monthly (12x per year)',
    firstTerm: { numPayments: 36, paidInterest: 0, paidPrincipal: 0, paidInTotal: 15258.7561 },
